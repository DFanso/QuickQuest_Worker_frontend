    ...
    const services = [
        {
            ...
            imageUrl: "/images/construction.png" // Replace with the path to your image
        },
        {
    ...
    return (
        <div className="mx-auto mt-4 py-4 md:py-2 max-w-screen-2xl px-2 md:px-20">
            ...
            <div className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4`}>
                ...
                {viewAll && services.length % 3 !== 0 && (
                    <div className="p-4">
                        <div className="flex flex-col items-center justify-center bg-white h-80 rounded-lg overflow-hidden shadow-md">
                            <button className="bg-teal-500 text-white rounded-full p-2 flex items-center justify-center h-12 w-12 mb-2"> {/* Adjusted padding and set height/width */}
                                <FontAwesomeIcon icon={faPlus} />
                            </button>
                            <span className="text-black">Add a new service</span> {/* Added text below the rounded icon */}
                        </div>
                    </div>
